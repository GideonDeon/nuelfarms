        ...
        <div>
          <div className="w-full flex flex-col items-center gap-2">
            {text.map((txt) => (
              <p
                key={txt.id}
                className="bg-[#4a8b71] text-white pt-2 pb-2 rounded-[14px] w-90 text-[14px] hover:-translate-y-1 transition-all duration-200 cursor-pointer"
              >
                <span className="inline-block w-5 h-5 bg-[#f1cf69] text-center text-[#7a6c43] rounded-[14px] -ml-2 mr-3">
                  &#10003;
                </span>
                {txt.text}
              </p>
